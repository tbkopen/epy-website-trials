...
description: "Boundary conditions are where physics stops being abstract and becomes accountable. A PDE can be elegant, a loss function can be “decreasing,” a solution…"
math: true
toc: true
show-authors: true
