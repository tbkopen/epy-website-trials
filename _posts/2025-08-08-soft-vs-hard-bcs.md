...
description: "In traditional numerical methods, boundary conditions are enforced rigidly — the solution must satisfy them. But in Physics-Informed Neural Networks…"
math: true
toc: true
show-authors: true
...
## Hard vs Soft Boundary Conditions - Want to Learn the Actual Implementation??
